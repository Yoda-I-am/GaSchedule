...
{
	for( hash_map<int, Professor*>::iterator it = professorsObject.begin(); it != professorsObject.end(); it++ )
		delete ( *it ).second;

	for( hash_map<int, StudentsGroup*>::iterator it = studentGroupsObjects.begin(); it != studentGroupsObjects.end(); it++ )
		delete ( *it ).second;

	for( hash_map<int, Course*>::iterator it = courseObjects.begin(); it != courseObjects.end(); it++ )
		delete ( *it ).second;

	for( hash_map<int, Room*>::iterator it = roomObjects.begin(); it != roomObjects.end(); it++ )
		delete ( *it ).second;

	for( list<CourseClass*>::iterator it = courseClassesObject.begin(); it != courseClassesObject.end(); it++ )
		delete *it;
}
...
void Configuration::ParseFile(char* fileName)
{
	...
	professorsObject.clear();
	studentGroupsObjects.clear();
	courseObjects.clear();
	roomObjects.clear();
	courseClassesObject.clear();
