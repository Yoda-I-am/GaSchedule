...
const int ROOM_CELL_HEIGHT = 80;

const int ROOM_MARGIN_WIDTH = 60;
const int ROOM_MARGIN_HEIGHT = 80;
...
void CChildView::OnPaint() 
{
	...
	CBrush bgBrush( RGB( 150, 192, 206 ) );
	...
	CBrush classBrush2( RGB( 190, 185, 181 ) );
	CBrush classBrush( RGB( 254, 246, 235 ) );
	CBrush overlapBrush( HS_BDIAGONAL, RGB( 255, 0, 0 ) );
	CPen overlapPen( PS_NULL, 1, RGB( 255, 0, 0 ) );
	dc.SelectObject(&classBrush2);
